              ...
              <div className="grid gap-4">
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-600">Report a stray or unaccompanied animal you have found</p>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-600">Report suspected cases of animal abuse or neglect</p>
                  </div>
                </button>
              </div>
            </div>
